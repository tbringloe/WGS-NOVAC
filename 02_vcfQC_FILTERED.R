...
var_qual <- read_delim(file.path(here::here(), "vcf_analyses/vcf_stats/filtered/FILE_filtered.lqual"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/filtered/FILTERED_qual_FILE.pdf"),
       plot = qual.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
var_depth <- read_delim(file.path(here::here(), "vcf_analyses/vcf_stats/filtered/FILE_filtered.ldepth.mean"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/filtered/FILTERED_siteDepth_FILE.pdf"),
       plot = site.depth.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
var_miss <- read_delim(file.path(here::here(), "vcf_analyses/vcf_stats/filtered/FILE_filtered.lmiss"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/filtered/FILTERED_siteMiss_FILE.pdf"),
       plot = site.miss.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
var_freq <- read_delim(file.path(here::here(), "vcf_analyses/vcf_stats/filtered/FILE_filtered.frq"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/filtered/FILTERED_maf_FILE.pdf"),
       plot = maf.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ind_depth <- read_delim(file.path(here::here(), "vcf_analyses/vcf_stats/filtered/FILE_filtered.idepth"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/filtered/FILTERED_indDepth_FILE.pdf"),
       plot = ind.depth.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ind_miss  <- read_delim(file.path(here::here(), "vcf_analyses/vcf_stats/filtered/FILE_filtered.imiss"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/filtered/FILTERED_indMiss_FILE.pdf"),
       plot = ind.miss.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ind_het <- read_delim(file.path(here::here(), "vcf_analyses/vcf_stats/filtered/FILE_filtered.het"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/filtered/FILTERED_indHet_FILE.pdf"),
       plot = ind.het.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")