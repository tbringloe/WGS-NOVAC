...
Providing organellar assembly was successful, the genomes are aligned using XXX (ref) and phylogenetic analysis is performed using RAxML (Stamatakis et al. 2014). Basic population statistics are also performed using PopGenome ([Pfeifer et al. 2014](#pfeifer).
