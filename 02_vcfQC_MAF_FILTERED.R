...
ggsave(filename = file.path(here::here(), "results/vcf_QC/MAFapplied/FILTERED_qual_FILE_MAF.pdf"),
       plot = qual.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/MAFapplied/FILTERED_siteDepth_FILE_MAF.pdf"),
       plot = site.depth.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/MAFapplied/FILTERED_siteMiss_FILE_MAF.pdf"),
       plot = site.miss.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/MAFapplied/FILTERED_maf_FILE_MAF.pdf"),
       plot = maf.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/MAFapplied/FILTERED_indDepth_FILE_MAF.pdf"),
       plot = ind.depth.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/MAFapplied/FILTERED_indMiss_FILE_MAF.pdf"),
       plot = ind.miss.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ggsave(filename = file.path(here::here(), "results/vcf_QC/MAFapplied/FILTERED_indHet_FILE_MAF.pdf"),
       plot = ind.het.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")