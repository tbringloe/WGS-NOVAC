...
var_qual <- read_delim(file.path(here::here(), "vcf_analyses/QC_RAW/FILE.lqual"), delim = "\t",
                       col_names = c("chr", "pos", "qual"), skip = 1)
qual.gg <- ggplot(var_qual, aes(qual)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
qual.gg <- qual.gg + theme_light()
ggsave(filename = file.path(here::here(), "vcf_analyses/QC_RAW/RAW_qual_FILE.pdf"),
       plot = qual.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
var_depth <- read_delim(file.path(here::here(), "vcf_analyses/QC_RAW/FILE.ldepth.mean"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "vcf_analyses/QC_RAW/RAW_siteDepth_FILE.pdf"),
       plot = site.depth.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
var_miss <- read_delim(file.path(here::here(), "vcf_analyses/QC_RAW/FILE.lmiss"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "vcf_analyses/QC_RAW/RAW_siteMiss_FILE.pdf"),
       plot = site.miss.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
var_freq <- read_delim(file.path(here::here(), "vcf_analyses/QC_RAW/FILE.frq"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "vcf_analyses/QC_RAW/RAW_maf_FILE.pdf"),
       plot = maf.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ind_depth <- read_delim(file.path(here::here(), "vcf_analyses/QC_RAW/FILE.idepth"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "vcf_analyses/QC_RAW/RAW_indDepth_FILE.pdf"),
       plot = ind.depth.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ind_miss  <- read_delim(file.path(here::here(), "vcf_analyses/QC_RAW/FILE.imiss"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "vcf_analyses/QC_RAW/RAW_indMiss_FILE.pdf"),
       plot = ind.miss.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")
...
ind_het <- read_delim(file.path(here::here(), "vcf_analyses/QC_RAW/FILE.het"), delim = "\t",
...
ggsave(filename = file.path(here::here(), "vcf_analyses/QC_RAW/RAW_indHet_FILE.pdf"),
       plot = ind.het.gg, 
       width = 8,
       height = 4,
       units = c("in"), bg = "white")